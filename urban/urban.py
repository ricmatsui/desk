# Modified from https://github.com/pimoroni/enviro/blob/main/enviro/boards/urban.py
...
qwst_i2c = PimoroniI2C(sda=4, scl=5)
sgp30 = BreakoutSGP30(qwst_i2c)
...
def get_sensor_readings():
  ...
  sgp30.set_baseline(38144, 35193)
  ...
  return {
    ...
    "ec02": air_quality[BreakoutSGP30.ECO2],
